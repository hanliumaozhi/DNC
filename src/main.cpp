...
uint256 hashGenesisBlock("0x4f1f17e44de474d356d7cbf5dc937637982b0066314df9723e945cca676ccd73");
...
static const int64 nTargetTimespan =  4 * 60 * 60; // SmallChange: 4 hours
...
bool LoadBlockIndex(bool fAllowNew)
{
	...
	// vMerkleTree: 5a2e19825b
        ...
        // Genesis block
        const char* pszTimestamp = "hello,there is dragoncoin,26/5/2013,zhaojundong";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 95 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("VCHsw3LqSF9qhwEtu3FkyFH6n1ZUcGwQzct6Hr3ne9PJ32qqgjVG") << OP_CHECKSIG; // a privkey for that 'vanity' pubkey would be interesting ;)
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1369562165;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2087656198;
        ...
        assert(block.hashMerkleRoot == uint256("0x9516b905d5d011a3ef862cdc8733a01563ba86e3ae25e5ccb2f0332d69578711"));
